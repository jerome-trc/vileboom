...
{
  color_rgb_t color = gld_LookupIndexedColor((invul_cm && !V_IsAutomapLightmodeIndexed()) ? playpal_white : playpal_black,
                                             V_IsUILightmodeIndexed() || V_IsAutomapLightmodeIndexed());
